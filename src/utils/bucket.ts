...
export class Bucket {
  ...
  /**
   * Enqueues an asynchronous function and returns a promise that resolves with its result.
   * @param func The async function to execute.
   * @param priority If true, the item will be prioritized.
   */
  execute<T>(func: () => Promise<T>, priority = false): Promise<T> {
