export class DialogBuilder {
   ...
   * @returns {DialogBuilder}
   */
  public addWorldLinkButton(buttonText: string, targetWorldName: string, buttonName: string = ""): DialogBuilder {
   ...
   * @returns {DialogBuilder}
   */
  public addPlayerInfo(playerName: string, level: string | number, currentExp: string | number, requiredExp: string | number): DialogBuilder {
